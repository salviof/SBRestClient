 ...
 * @author sfurbino
 */
public interface ItfFabricaIntegracaoApi {
    ...
    public default ItfAcaoApiCliente getAcaoUsuarioLogado(ItfUsuario pUsuario, Object... parametros) {
    ...
    public default ItfTokenGestao getGestaoToken() {
        ...
        if (tokenGestao == null) {
            tokenGestao = UtilSBIntegracaoClientReflexao.getNovaInstanciaGestaoAutenticador(this, FabTipoAgenteClienteApi.SISTEMA, null);
    ...
    public default ItfTokenGestao getGestaoToken(ItfUsuario pUsuario) {
        ...
        if (tokenGestao == null) {
            tokenGestao = UtilSBIntegracaoClientReflexao.getNovaInstanciaGestaoAutenticador(this, FabTipoAgenteClienteApi.USUARIO, pUsuario);
